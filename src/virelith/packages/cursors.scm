;;; Cursor theme packages for Virelith.
...
(define %fluent-cursor-theme-sha256
  ...
  (package
    ...
    (source
     (origin
       ...
       ;; Same upstream checkout as fluent-icon-theme; keep this hash in
       ;; sync with %fluent-icon-theme-sha256 in (virelith packages icons).
       (sha256 %fluent-cursor-theme-sha256)))
